...
import com.netut.sudustrial.block.tnt_type.EffectTntType;
...
public class EffectTntBlock extends Block {
    private final EffectTntType type;

    public EffectTntBlock(EffectTntType type, Properties properties) {
        super(properties);
        this.type = type;
    }

    public EffectTntType getType() {
        return type;
    }
