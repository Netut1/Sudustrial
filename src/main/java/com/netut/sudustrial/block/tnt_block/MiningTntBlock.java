...
import com.netut.sudustrial.block.tnt_type.MiningTntType;
...
public class MiningTntBlock extends Block {
    private final MiningTntType type;

    public MiningTntBlock(MiningTntType type, Properties properties) {
        super(properties);
        this.type = type;
    }

    public MiningTntType getType() {
        return type;
    }
