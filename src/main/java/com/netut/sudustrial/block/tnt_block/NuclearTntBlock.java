...
import com.netut.sudustrial.block.tnt_type.NuclearTntType;
...
public class NuclearTntBlock extends Block {
    private final NuclearTntType type;

    public NuclearTntBlock(NuclearTntType type, Properties properties) {
        super(properties);
        this.type = type;
    }

    public NuclearTntType getType() {
        return type;
    }
