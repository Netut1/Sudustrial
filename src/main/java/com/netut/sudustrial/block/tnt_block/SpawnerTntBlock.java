package com.netut.sudustrial.block.tnt_block;

import com.netut.sudustrial.block.tnt_type.SpawnerTntType;
...
public class SpawnerTntBlock extends Block {
    private final SpawnerTntType type;

    public SpawnerTntBlock(SpawnerTntType type, Properties properties) {
        super(properties);
        this.type = type;
    }

    public SpawnerTntType getType() {
        return type;
    }
